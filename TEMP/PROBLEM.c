...
#define	k_tl_LacI          (*amigo_model).pars[12]
#define	kdeg_mRNA_LacI     (*amigo_model).pars[13]
#define	k_deg_LacI_protein (*amigo_model).pars[14]
#define	k_tl_TetR          (*amigo_model).pars[15]
#define	kdeg_mRNA_TetR     (*amigo_model).pars[16]
#define	k_deg_TetR_protein (*amigo_model).pars[17]
#define	k_tl_cI            (*amigo_model).pars[18]
#define	kdeg_mRNA_cI       (*amigo_model).pars[19]
#define	k_deg_cI_protein   (*amigo_model).pars[20]
#define	Y1                 (*amigo_model).pars[21]
#define	Y2                 (*amigo_model).pars[22]
#define	Y3                 (*amigo_model).pars[23]
#define	Y4                 (*amigo_model).pars[24]
#define	Y5                 (*amigo_model).pars[25]
#define	Y6                 (*amigo_model).pars[26]
#define	Y7                 (*amigo_model).pars[27]
#define	Y8                 (*amigo_model).pars[28]
#define	Y9                 (*amigo_model).pars[29]
...
int amigoRHS(realtype t, N_Vector y, N_Vector ydot, void *data){
	...
	dLacI_CDS=+Y1*LacIRep_PROM+Y2*TetRRep_PROM+Y3*cIRep_PROM-kdeg_mRNA_LacI*LacI_CDS;
	dTetR_CDS=+Y4*LacIRep_PROM+Y5*TetRRep_PROM+Y6*cIRep_PROM-kdeg_mRNA_TetR*TetR_CDS;
	dcI_CDS=+Y7*LacIRep_PROM+Y8*TetRRep_PROM+Y9*cIRep_PROM-kdeg_mRNA_cI*cI_CDS;
