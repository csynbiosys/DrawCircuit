...
#define	w_promoter1_LACI (*amigo_model).pars[8]
#define	w_promoter2_LACI (*amigo_model).pars[9]
#define	tau_LACI         (*amigo_model).pars[10]
#define	w_promoter1_TETR (*amigo_model).pars[11]
#define	w_promoter2_TETR (*amigo_model).pars[12]
#define	tau_TETR         (*amigo_model).pars[13]
...
#define ATC 	((*amigo_model).controls_v[1][(*amigo_model).index_t_stim]+(t-(*amigo_model).tlast)*(*amigo_model).slope[1][(*amigo_model).index_t_stim])
